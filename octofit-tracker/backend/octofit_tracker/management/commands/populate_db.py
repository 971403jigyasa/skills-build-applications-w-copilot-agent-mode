...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        User.objects.create(email='cap@marvel.com', name='Captain America', team='marvel', is_active=True)
        ...
        # Create activities
        Activity.objects.create(user='ironman@marvel.com', type='run', duration=30, date='2026-03-06')
        Activity.objects.create(user='cap@marvel.com', type='cycle', duration=45, date='2026-03-06')
        Activity.objects.create(user='thor@marvel.com', type='swim', duration=20, date='2026-03-06')
        Activity.objects.create(user='superman@dc.com', type='fly', duration=60, date='2026-03-06')
        Activity.objects.create(user='batman@dc.com', type='run', duration=25, date='2026-03-06')
        Activity.objects.create(user='wonderwoman@dc.com', type='jump', duration=15, date='2026-03-06')
